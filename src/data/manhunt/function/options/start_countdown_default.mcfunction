...
scoreboard players set #expected_start_countdown var 600
...
scoreboard players operation #expected_start_countdown var += #start_countdown_extra var

execute if score #expected_start_countdown var matches ..-1 run scoreboard players set #expected_start_countdown var 0