...
scoreboard players operation #start_countdown_integer var = #start_countdown var
scoreboard players operation #start_countdown_integer var /= #20 var
scoreboard players operation #start_countdown_tenths_place var = #start_countdown var
