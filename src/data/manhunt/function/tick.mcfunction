...
execute as @a[scores={hit_feedback_=1}] at @s if score @s damage_taken > @s damage_taken_old if score @s hit_feedback_on matches 2.. run function manhunt:do_hit_feedback
