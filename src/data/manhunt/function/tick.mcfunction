...
execute as @a[scores={joined=20}] run function manhunt:starting/gm_change

execute unless score #game_started var matches 1.. if score #pausing var matches 0 run function manhunt:starting/actionbar_player_count
execute if score #game_started var matches 1 if score #pausing var matches 0 run function manhunt:timer/tick_game_started
