...
# Options Inits
execute unless data storage manhunt: options.difficulty run data modify storage manhunt: options.difficulty set value "hard"
...
execute unless score #locator_bar var matches 1 in overworld run gamerule locator_bar false
execute unless score #locator_bar var matches 1 in the_end run gamerule locator_bar false
execute unless score #locator_bar var matches 1 in the_nether run gamerule locator_bar false
execute if score #locator_bar var matches 1 in overworld run gamerule locator_bar true
execute if score #locator_bar var matches 1 in the_end run gamerule locator_bar true
execute if score #locator_bar var matches 1 in the_nether run gamerule locator_bar true
...
execute at @n[tag=hunter_anchor] run spawnpoint @a[team=hunter] ~ ~ ~
...
execute if score #start_countdown var matches 0 run function manhunt:start_countdown/time_immediately_up
